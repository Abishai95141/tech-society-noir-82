...
export default function Index() {
  ...
  return (
    <main>
      ...
      <section
        className="relative overflow-hidden min-h-[90vh] md:min-h-[100vh]"
      ...
      >
        ...
        <div aria-label="Interactive 3D robot — drag to rotate" className="absolute inset-0 w-full h-full">
          ...
          {/* Spline embed (lazy) */}
          {showSpline && !reducedMotion && (
            <div className="absolute inset-0 origin-[50%_100%] scale-[1.12] translate-y-[28px] md:scale-[1.25] md:translate-y-[36px] xl:scale-[1.35] xl:translate-y-[48px]">
              <spline-viewer
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 h-full flex flex-col justify-center pointer-events-none">
